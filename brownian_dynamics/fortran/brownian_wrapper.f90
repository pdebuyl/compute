...
contains
  ...
  subroutine c_srk_with_tracer(x0, tracer_x0, D, tracer_D, dt, nsteps, hat_a, hat_g, k, data, tracer_data, dim, n_bath) bind(c)
    ...
    call srk_with_tracer(x0, tracer_x0, D, tracer_D, dt, nsteps, hat_a, hat_g, k, data, tracer_data)
